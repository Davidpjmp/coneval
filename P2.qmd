...
table(concentrado2020$r401) # un tabulado simple
```
...
dplyr::glimpse(concentrado2020[,1:10]) # en corchete del lado derecho podemos ojear columnas 
...
print(get_labels(concentrado2020[, 1:10])) #de las primeras 10 variables
