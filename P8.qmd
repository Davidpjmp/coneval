...
En los datos incluiremos la variable que queremos graficar,
en este caso la jefatura de hogar. Lo guardaremos como un objeto.
...
Vemos que graficamos nuestra variable, sin embargo, todavía
no hemos especificado la geometría así que la vamos a agregar.
...
Para hacer nuestra gráfica de barras y que se vean 
las etiquetas con facilidad, vamos a etiquetar nuestra variable.
